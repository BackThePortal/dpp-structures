...
nlohmann::json i_json_file::operator()(const std::string& key, const std::string& _default) {
	return this->get_obj(key, _default);
}

std::string i_json_file::get_string(const std::string& key, const std::string& _default) {
	return this->get_obj(key, _default);
}

nlohmann::json i_json_file::get_obj(const std::string& key, const nlohmann::json& _default) {
	this->read();
	nlohmann::json json = this->json.value(key, _default);
	this->forget();
	return json;
}
...
io_json_file::io_json_file(const std::string& path) : json_file_base(path) {}
